...
from .phi3_model import Phi3Model, Phi3ForCausalLM

from transformers.modeling_outputs import CausalLMOutputWithPast
from transformers.generation.utils import GenerateOutput

from ..model_arch import LlavaMetaModel, LlavaMetaForCausalLM
...
class LlavaPhi3ForCausalLM(Phi3ForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        cache_position: Optional[List[int]] = None, # just for newer transformers libraries
    ...
    def prepare_inputs_for_generation(self, input_ids, past_key_values=None,
        ...
        if "cache_position" in inputs:
            # for combatibility with newer transformers libraries
